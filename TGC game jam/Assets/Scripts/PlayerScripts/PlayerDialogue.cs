...
public class PlayerDialogue : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        typewriter = DialogueManagerOld.Instance.Typewriter;
        ...
        private void OnGameStartsPlayerWakesUp()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerInternalMonologueData, playerTalkTransform, true, () => {
        });
    }
    ...
    public void FindLora(Transform t)
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(ids, playerInternalMonologueData, t, false);
    }
    
    public void SendLetter()
    {
        var ids = new List<string> { "sendletter" };
        DialogueManagerOld.Instance.StartDialogueSequence(ids, playerInternalMonologueData, playerTalkTransform, false);
    }
    ...
    public void EndTalk()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(ids, playerInternalMonologueData, playerTalkTransform, true, () => {
        });   
    }
    ...
    public async UniTask Day1Bolu()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, playerTalkTransform, true, () => {
        });
    ...
    public async UniTask Day1Grandma()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, playerTalkTransform, false);
    ...
    public async UniTask Day1Grandma2()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, GameVariables.GrandmaInSecondFloor, false);
    ...
    public async UniTask Day1Restaurant()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, GameVariables.Restaurant, false);
    ...
    public void Day2Grandma()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, GameVariables.GrandmaInSecondFloor, true, () => {
        });
    ...
    public void Day2Restaurant()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, GameVariables.Restaurant, true, () => {
        });
    ...
    public void Day3ToBolu()
    {
        ...
        DialogueManagerOld.Instance.StartDialogueSequence(dialogueIDs, playerToNPClogueData, GameVariables.BoluSetInStore, true, () => {
        });
